...
export default class Core {
    constructor(globals) {
        if (!globals)
            throw new Error('Must pass in globals object from application to all classes that extend core, to enable access to environment, services, client, socket and io etc');
