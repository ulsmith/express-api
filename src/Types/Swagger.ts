export enum SwaggerSchemaContentTypesType {
...
export type SwaggerSchemaObjectParameterType = {
	...
	properties: {
		[key: string]: SwaggerSchemaParametersType | { description: '$repeat.parent'};
	};
};
...
export type SwaggerSchemaArrayParameterType = {
	...
	type: 'array';
	default?: [];
	items: SwaggerSchemaParametersType | { description: '$repeat.parent'};
};
...
export type SwaggerSchemaParametersType = SwaggerSchemaStringParameterType | SwaggerSchemaNumberParameterType | SwaggerSchemaBooleanParameterType | SwaggerSchemaObjectParameterType | SwaggerSchemaArrayParameterType | SwaggerSchemaUnionParameterType | SwaggerSchemaOneOfParameterType | { description: string };
